package fr.raksrinana.editsign.config.validator;
...
public class ItemIdRunner implements ValidatorRunner<ItemId>{
	...
	private static final Text errorText = new TranslatableText("text.autoconfig.editsign.error.invalidItemResourceLocation");
